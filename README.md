...
> **Please note**: The plugin that facilitates automatic extraction of content, as described below, is currently inactive. For a well displayed post, please include all optional content. 
